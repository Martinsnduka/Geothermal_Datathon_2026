...
The Geothermal_Thermo_GIS notebook is the main notebook for challenge 1, open with Git Dev if file is too big 
...
## Business Challenges
**Challenge 1** — Resource Assessment Assess the geothermal potential of the area using the provided well data and determine whether the geothermal resources can support district heating and cooling.

**Challenge 2** — System Design Design an integrated heating and cooling system capable of supplying the neighbourhood demand of 15 MW using geothermal energy.
...
System Design (ASPEN Plus V14) ──► 8-Stage Integrated Plant Simulation
...
### System Design — 8 Stages (ASPEN Plus V14)
...
| Tool | Purpose |
|---|---|
| **Python** (pandas, numpy, matplotlib, seaborn) | Data analysis, EDA, visualisation |
...
**GeoSpark Team** — AFRICA SPE Datathon, June 2026
